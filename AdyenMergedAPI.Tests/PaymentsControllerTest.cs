...
namespace AdyenMergedAPI.Tests
{
    ...
    public class PaymentsControllerTest : ControllerTestBase
    {
        ...
        [Test]
        public async Task TestTestPostCardDetails()
        {
            // Parameters for the API call
            string idempotencyKey = "37ca9c97-d1d1-4c62-89e8-706891a563ed";
            Standard.Models.CardDetailsRequest body = ApiHelper.JsonDeserialize<Standard.Models.CardDetailsRequest>("{\"merchantAccount\":\"YOUR_MERCHANT_ACCOUNT\",\"cardNumber\":\"411111\"}");

            // Perform API call
            Standard.Models.CardDetailsResponse result = null;
            try
            {
                result = await this.controller.PostCardDetailsAsync(idempotencyKey, body);
            }
            catch (ApiException)
            {
            }
            ...
            Assert.IsTrue(
                    ...
                    "{\"brands\":[{\"type\":\"visa\",\"supported\":true},{\"type\":\"cartebancaire\",\"supported\":true}]}",
        ...
        /// <returns>A <see cref="Task"/> representing the asynchronous unit test.</returns>
        [Test]
        public async Task TestTestPostDonations()
        {
            // Parameters for the API call
            string idempotencyKey = "37ca9c97-d1d1-4c62-89e8-706891a563ed";
            Standard.Models.DonationPaymentRequest body = ApiHelper.JsonDeserialize<Standard.Models.DonationPaymentRequest>("{\"amount\":{\"currency\":\"EUR\",\"value\":1000},\"reference\":\"YOUR_DONATION_REFERENCE\",\"paymentMethod\":{\"type\":\"scheme\"},\"donationToken\":\"YOUR_DONATION_TOKEN\",\"donationOriginalPspReference\":\"991559660454807J\",\"donationAccount\":\"CHARITY_ACCOUNT\",\"returnUrl\":\"https://your-company.com/...\",\"merchantAccount\":\"YOUR_MERCHANT_ACCOUNT\",\"shopperInteraction\":\"ContAuth\"}");

            // Perform API call
            Standard.Models.DonationPaymentResponse result = null;
            try
            {
                result = await this.controller.PostDonationsAsync(idempotencyKey, body);
            }
            catch (ApiException)
            {
            }
            ...
            Assert.IsTrue(
                    TestHelper.IsProperSubsetOf(
                    "{\"id\":\"UNIQUE_RESOURCE_ID\",\"status\":\"completed\",\"donationAccount\":\"CHARITY_ACCOUNT\",\"merchantAccount\":\"YOUR_MERCHANT_ACCOUNT\",\"amount\":{\"currency\":\"EUR\",\"value\":1000},\"reference\":\"YOUR_DONATION_REFERENCE\",\"payment\":{\"pspReference\":\"8535762347980628\",\"resultCode\":\"Authorised\",\"amount\":{\"currency\":\"EUR\",\"value\":1000},\"merchantReference\":\"YOUR_DONATION_REFERENCE\"}}",
                    TestHelper.ConvertStreamToString(HttpCallBack.Response.RawBody),
                    false,
                    true,
                    false),
        ...
        /// <returns>A <see cref="Task"/> representing the asynchronous unit test.</returns>
        [Test]
        public async Task TestTestPostPaymentMethods()
        {
            // Parameters for the API call
            string idempotencyKey = "37ca9c97-d1d1-4c62-89e8-706891a563ed";
            Standard.Models.PaymentMethodsRequest body = ApiHelper.JsonDeserialize<Standard.Models.PaymentMethodsRequest>("{\"merchantAccount\":\"YOUR_MERCHANT_ACCOUNT\"}");

            // Perform API call
            Standard.Models.PaymentMethodsResponse result = null;
            try
            {
                result = await this.controller.PostPaymentMethodsAsync(idempotencyKey, body);
            }
            catch (ApiException)
            {
            }
        ...
        /// <returns>A <see cref="Task"/> representing the asynchronous unit test.</returns>
        [Test]
        public async Task TestTestPostPayments()
        {
            // Parameters for the API call
            string idempotencyKey = "37ca9c97-d1d1-4c62-89e8-706891a563ed";
            Standard.Models.PaymentRequest body = ApiHelper.JsonDeserialize<Standard.Models.PaymentRequest>("{\"amount\":{\"currency\":\"USD\",\"value\":1000},\"reference\":\"Your order number\",\"paymentMethod\":{\"type\":\"applepay\",\"applePayToken\":\"VNRWtuNlNEWkRCSm1xWndjMDFFbktkQU...\"},\"returnUrl\":\"https://your-company.com/...\",\"merchantAccount\":\"YOUR_MERCHANT_ACCOUNT\"}");

            // Perform API call
            Standard.Models.PaymentResponse result = null;
            try
            {
                result = await this.controller.PostPaymentsAsync(idempotencyKey, body);
            }
            catch (ApiException)
            {
            }
            ...
            Assert.IsTrue(
                    TestHelper.IsProperSubsetOf(
                    "{\"additionalData\":{\"cvcResult\":\"1 Matches\",\"authCode\":\"044925\",\"avsResult\":\"4 AVS not supported for this card type\",\"avsResultRaw\":\"4\",\"cvcResultRaw\":\"M\",\"refusalReasonRaw\":\"AUTHORISED\",\"acquirerCode\":\"TestPmmAcquirer\",\"acquirerReference\":\"8PQMP9VEP3H\"},\"pspReference\":\"993617895204576J\",\"resultCode\":\"Authorised\",\"merchantReference\":\"string\"}",
                    TestHelper.ConvertStreamToString(HttpCallBack.Response.RawBody),
                    false,
                    true,
                    false),
        ...
        /// <returns>A <see cref="Task"/> representing the asynchronous unit test.</returns>
        [Test]
        public async Task TestTestPostPaymentsDetails()
        {
            // Parameters for the API call
            string idempotencyKey = "37ca9c97-d1d1-4c62-89e8-706891a563ed";
            Standard.Models.PaymentDetailsRequest body = ApiHelper.JsonDeserialize<Standard.Models.PaymentDetailsRequest>("{\"details\":{\"redirectResult\":\"X6XtfGC3!Y...\"}}");

            // Perform API call
            Standard.Models.PaymentDetailsResponse result = null;
            try
            {
                result = await this.controller.PostPaymentsDetailsAsync(idempotencyKey, body);
            }
            catch (ApiException)
            {
            }
        ...
        /// <returns>A <see cref="Task"/> representing the asynchronous unit test.</returns>
        [Test]
        public async Task TestTestPostSessions()
        {
            // Parameters for the API call
            string idempotencyKey = "37ca9c97-d1d1-4c62-89e8-706891a563ed";
            Standard.Models.CreateCheckoutSessionRequest body = ApiHelper.JsonDeserialize<Standard.Models.CreateCheckoutSessionRequest>("{\"merchantAccount\":\"YOUR_MERCHANT_ACCOUNT\",\"amount\":{\"value\":100,\"currency\":\"EUR\"},\"returnUrl\":\"https://your-company.com/checkout?shopperOrder=12xy..\",\"reference\":\"YOUR_PAYMENT_REFERENCE\",\"countryCode\":\"NL\"}");

            // Perform API call
            Standard.Models.CreateCheckoutSessionResponse result = null;
            try
            {
                result = await this.controller.PostSessionsAsync(idempotencyKey, body);
            }
            catch (ApiException)
            {
            }
            ...
            Assert.IsTrue(
                    TestHelper.IsProperSubsetOf(
                    "{\"amount\":{\"currency\":\"EUR\",\"value\":100},\"countryCode\":\"NL\",\"expiresAt\":\"2022-01-11T13:53:18+01:00\",\"id\":\"CS451F2AB1ED897A94\",\"merchantAccount\":\"YOUR_MERCHANT_ACCOUNT\",\"reference\":\"YOUR_PAYMENT_REFERENCE\",\"returnUrl\":\"https://your-company.com/checkout?shopperOrder=12xy..\",\"sessionData\":\"Ab02b4c0!BQABAgBfYI29...\"}",
                    TestHelper.ConvertStreamToString(HttpCallBack.Response.RawBody),
                    false,
                    true,
                    false),
