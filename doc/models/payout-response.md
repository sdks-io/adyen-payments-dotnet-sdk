...
| `DccAmount` | [`Amount`](../../doc/models/amount.md) | Optional | Includes the currency of the conversion and the value of the transaction.<br><br>> This value only applies if you have implemented Dynamic Currency Conversion. For more information, [contact Support](https://www.adyen.help/hc/en-us/requests/new). |
...
| `FraudResult` | [`FraudResult2`](../../doc/models/fraud-result-2.md) | Optional | The fraud result properties of the payment. |
