...
| `ModificationAmount` | [`Amount19`](../../doc/models/amount-19.md) | Required | The amount that needs to be adjusted. The `currency` must match the currency used in authorisation, the `value` must be smaller than or equal to the authorised amount. |
