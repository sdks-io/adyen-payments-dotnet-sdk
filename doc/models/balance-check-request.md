...
| `PaymentMethod` | `Dictionary<string, string>` | Required | The collection that contains the type of the payment method and its specific information. |
